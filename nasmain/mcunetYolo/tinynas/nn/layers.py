...
from .customised_layers import McuYoloDetectionHead

__all__ = ['set_layer_from_config', 'My2DLayer', 'ConvLayer', 'ConvLayerPad', 'DepthConvLayer', 'PoolingLayer', 'IdentityLayer',
           'LinearLayer', 'ZeroLayer', 'MBInvertedConvLayer', 'McuYoloDetectionHead']
...
def set_layer_from_config(layer_config):
    ...
    name2layer = {
        ...
        ConvLayerPad.__name__: ConvLayerPad,
        ...
        McuYoloDetectionHead.__name__: McuYoloDetectionHead, # register my customerised detection head here
    }

    config_copy = copy.deepcopy(layer_config)
    layer_name = config_copy.pop('name')
    layer = name2layer[layer_name]
    return layer.build_from_config(config_copy)
...
class ConvLayerPad(My2DLayer):
    ...
    def __init__(self, in_channels, out_channels,
        ...
        super(ConvLayerPad, self).__init__(in_channels, out_channels, use_bn, act_func, dropout_rate, ops_order)
    ...
    def config(self):
        return {
            ...
            **super(ConvLayerPad, self).config,
        }

    @staticmethod
    def build_from_config(config):
        return ConvLayerPad(**config)
