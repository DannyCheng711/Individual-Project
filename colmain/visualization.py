...
img_paths = [
    "./colmain/decision_fusion/result/pr_curve_comp_view2_occ30_occ30.png",
    "./colmain/decision_fusion/result/pr_curve_comp_view2_occ30_occ50.png",
    "./colmain/decision_fusion/result/pr_curve_comp_view2_occ50_occ50.png",
]
...
plt.tight_layout()
plt.subplots_adjust(wspace=0.01, hspace=0.01)  # Make gaps very small
plt.savefig("./colmain/output/pr_curve_view2_panel.png", dpi=300, bbox_inches="tight")
plt.show()
